...
//       </ScrollReveal>
    ...
    <div style={{ padding: '20px', textAlign: 'center', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div>
        <h1 style={{ fontSize: '3rem', color: '#2563eb', marginBottom: '1rem' }}>PLEVIA CITY</h1>
        ...
        <div style={{ marginTop: '2rem', padding: '1rem', backgroundColor: '#f3f4f6', borderRadius: '8px' }}>
          <p style={{ margin: '0.5rem 0' }}>
            <strong>Vị trí:</strong> 63–65 Lý Nam Đế, p. Hội Phú, t.Gia Lai
          </p>
          <p style={{ margin: '0.5rem 0' }}>
            <strong>Diện tích:</strong> 7,04 ha
          </p>
          <p style={{ margin: '0.5rem 0' }}>
            <strong>Quy mô:</strong> 368 căn nhà phố & shophouse
          </p>
        </div>
      </div>
    </div>
