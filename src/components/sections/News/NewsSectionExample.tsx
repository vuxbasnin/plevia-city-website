...
const sampleNewsItems = [
  ...
  },
  {
    ...
    description: 'Hà Nội, ngày 14/06/2025 - Chủ đầu tư BẮC HẢI đã ký kết hợp tác cùng 10 đơn vị phân phối chính thức dự án Plevia City, đánh dấu cột mốc quan trọng trong chiến lược phát triển giai đoạn mới của dự án, chuẩn bị cho kế hoạch mở rộng thị trường.',
  ...
  },
  {
    ...
    description: 'BẮC HẢI chính thức ký kết hợp tác với Trung tâm chăm sóc sức khỏe cao cấp Prime Medical Care (PMC), tích hợp mô hình y tế chủ động vào dự án Plevia City, góp phần hoàn thiện hệ sinh thái sống xanh – sống khỏe - sống bền vững.',
  ...
  {
    id: '4',
    title: 'KHÁM PHÁ KHÔNG GIAN LÀM VIỆC HIỆN ĐẠI TẠI PLEVIA CITY',
    description: 'Tại Plevia City, chúng tôi mang đến không gian làm việc hiện đại với đầy đủ tiện nghi, kết hợp hài hòa giữa thiên nhiên và công nghệ, tạo môi trường lý tưởng cho sự sáng tạo và năng suất.',
    imageUrl: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&h=600&fit=crop',
    alt: 'Modern workspace with nature view'
  },
  {
    id: '5',
    title: 'CỘNG ĐỒNG PLEVIA CITY: NƠI KẾT NỐI VÀ PHÁT TRIỂN',
    description: 'Không chỉ là nơi sinh sống, Plevia City còn là cộng đồng nơi mọi người kết nối, chia sẻ và cùng nhau phát triển. Các hoạt động cộng đồng đa dạng giúp tạo nên môi trường sống năng động và gắn kết.',
  ...
  },
  {
    ...
    description: 'Kiến trúc tại Plevia City được thiết kế theo nguyên tắc xanh, tối ưu hóa ánh sáng tự nhiên, thông gió và tích hợp cây xanh vào không gian sống, tạo nên môi trường sống lành mạnh và bền vững.',
