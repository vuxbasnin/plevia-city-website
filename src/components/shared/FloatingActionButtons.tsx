...
import { Phone, MessageSquare, Facebook, Youtube, Plus } from 'lucide-react';
...
export default function FloatingActionButtons({ className }: FloatingActionButtonsProps) {
  ...
  return (
    <div ref={containerRef} className={cn("fixed bottom-20 right-6 z-40 flex flex-col-reverse items-end space-y-3 space-y-reverse", className)}>
      <AnimatePresence>
        {/* Nút chính để toggle */}
        <motion.div
          key="main-toggle-fab"
        ...
        {/* Các nút con chỉ hiển thị khi expanded */}
        {isExpanded && (
          <>
            {/* Nút điện thoại */}
            {hasPhoneNumber && (
