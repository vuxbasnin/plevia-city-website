export const lifestyleBannerImage = '/assets/lifestyle/banner_lifestyle.png';

export const sectionModernStandard = {
...
export const sectionCommunity = {
    ...
    description: '',
    sections: [
        { level: 1 as const, subtitle: '', subdescription: `Tại Plevia City, mỗi cư dân không chỉ là hàng xóm – mà còn là một phần của một cộng đồng văn minh, gắn kết.` },
        { level: 2 as const, subtitle: '', subdescription: `Tại đây, giá trị sống không chỉ đo bằng tiện nghi hiện đại, mà còn bằng những mối quan hệ bền chặt và sự sẻ chia giữa những con người cùng chung lý tưởng “Sống xanh – Sống thông minh – Sống hạnh phúc”.` },
    ],
    is169: true,
    reverse: true,
    images: [
...
export const sectionSmartExperience = {
...
export const sectionCommunityConnect = {
